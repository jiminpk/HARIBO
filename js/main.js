...
function initLineupCards() {
  // 호버 가능한 디바이스(데스크탑)에서만 이미지 확대 효과 적용
...
function initHeroVideo() {
  ...
  function setVideoSrc(isMobile) {
    const src = isMobile
      ? 'https://cipvhszutxucymztqswc.supabase.co/storage/v1/object/public/hrb/haribo-mobile.mp4'
      : 'https://cipvhszutxucymztqswc.supabase.co/storage/v1/object/public/hrb/haribo-pc.mp4';
    const poster = isMobile
      ? 'img/main_page/haribo-mobile.jpg'
      : 'img/main_page/haribo-pc.jpg';
  ...
  mq.addEventListener('change', e => setVideoSrc(e.matches));
}
